# HeroSection — corrected desktop/mobile CSS
...
#brxe-wajdtr {
  ...
  line-height: 44PX;
  letter-spacing: 0px;
  text-shadow: 0 0 30px var(--bricks-color-otnukj);
}
#brxe-wprjcn {
  color: #f5f5f5;
  text-align: center;
...
#brxe-ywfgdp::before {
  background-image: linear-gradient(217deg, rgba(28, 39, 40, 0), rgba(28, 39, 40, 0.44));
  position: absolute;
  content: "";
  top: 0;
  right: 0;
...
@media (max-width: 478px) {
  #brxe-wajdtr {
    ...
    font-weight: 900;
    letter-spacing: -1px;
    text-shadow: 0 0 0 var(--bricks-color-otnukj);
    border-width: 2px;
    border-color: #ffffff;
    margin-top: 150px;
  }
  #brxe-wprjcn {
    font-size: 1em;
    text-shadow: 0 0 17px var(--bricks-color-otnukj);
  }
  #brxe-rxkiae {
    margin-bottom: 0;
  }
...
## Properties that genuinely CHANGE at 478px (18)
| selector | property | desktop | mobile |
|---|---|---|---|
| `#brxe-wajdtr` | `font-size` | `<not set at desktop>` | `1.5em` |
| `#brxe-wajdtr` | `line-height` | `44PX` | `0.8em` |
| `#brxe-wajdtr` | `font-weight` | `<not set at desktop>` | `900` |
| `#brxe-wajdtr` | `letter-spacing` | `0px` | `-1px` |
| `#brxe-wajdtr` | `text-shadow` | `0 0 30px var(--bricks-color-otnukj)` | `0 0 0 var(--bricks-color-otnukj)` |
| `#brxe-wajdtr` | `border-width` | `<not set at desktop>` | `2px` |
| `#brxe-wajdtr` | `border-color` | `<not set at desktop>` | `#ffffff` |
| `#brxe-wajdtr` | `margin-top` | `<not set at desktop>` | `150px` |
| `#brxe-wprjcn` | `font-size` | `1.2em` | `1em` |
| `#brxe-wprjcn` | `text-shadow` | `<not set at desktop>` | `0 0 17px var(--bricks-color-otnukj)` |
| `#brxe-rxkiae` | `margin-bottom` | `100px` | `0` |
| `#brxe-yuirpz` | `padding-top` | `445px` | `0` |
| `#brxe-yuirpz` | `width` | `666PX` | `100%` |
| `#brxe-quotpt` | `padding-right` | `<not set at desktop>` | `1em` |
| `#brxe-quotpt` | `padding-left` | `<not set at desktop>` | `1em` |
| `#brxe-ywfgdp` | `padding-top` | `<not set at desktop>` | `18em` |
| `#brxe-ywfgdp` | `padding-bottom` | `<not set at desktop>` | `3em` |
| `#brxe-ywfgdp` | `height` | `110vh` | `95vh` |
