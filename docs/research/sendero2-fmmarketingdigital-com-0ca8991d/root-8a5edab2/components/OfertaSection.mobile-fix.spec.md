# OfertaSection — corrected desktop/mobile CSS
...
#brxe-axagmd .next-image-accordion__content {
  ...
  left: 0px;
  bottom: 0px;
  background-color: rgba(0, 153, 165, 0.23);
  color: #fff;
  --fade-duration: 0.3s;
  --fade-ease: ease-out;
}
...
#brxe-fehoaj {
  ...
  --duration: 0.6s;
  --ease: cubic-bezier(0.22, 1, 0.36, 1);
  background: var(--bricks-color-vvsbjv);
  color: #1c2728;
  margin-right: 3px;
  margin-bottom: 1em;
  margin-left: 20px;
...
#brxe-cghplz::before {
  background-image: linear-gradient(rgba(255, 255, 255, 0.74), #0099a5);
  position: absolute;
  content: "";
  top: 0;
  right: 0;
...
## Properties that genuinely CHANGE at 478px (70)
| selector | property | desktop | mobile |
|---|---|---|---|
| `#brxe-auibpk` | `text-align` | `left` | `center` |
| `#brxe-auibpk` | `font-size` | `<not set at desktop>` | `1.9em` |
| `#brxe-auibpk` | `font-family` | `<not set at desktop>` | `"Google Sans Flex"` |
| `#brxe-iipjuc` | `margin-top` | `50px` | `0` |
| `#brxe-mfasco` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-mfasco` | `align-items` | `<not set at desktop>` | `center` |
| `#brxe-mfasco` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-eyhsuq` | `flex-direction` | `<not set at desktop>` | `column` |
| `#brxe-eyhsuq` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-eyhsuq` | `height` | `<not set at desktop>` | `265px` |
| `#brxe-lwfvvc` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-lwfvvc` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-lwfvvc` | `align-items` | `<not set at desktop>` | `center` |
| `#brxe-lwfvvc` | `flex-direction` | `<not set at desktop>` | `column` |
| `#brxe-mqpyqy` | `margin-top` | `50px` | `0` |
| `#brxe-padvyl` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-padvyl` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-padvyl` | `align-items` | `<not set at desktop>` | `center` |
| `#brxe-juglpu` | `height` | `<not set at desktop>` | `265px` |
| `#brxe-juglpu` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-juglpu` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-juglpu` | `flex-direction` | `<not set at desktop>` | `column` |
| `#brxe-ffeadr` | `height` | `<not set at desktop>` | `300px` |
| `#brxe-ffeadr` | `flex-direction` | `<not set at desktop>` | `column` |
| `#brxe-ffeadr` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-ffeadr` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-ffeadr` | `align-items` | `<not set at desktop>` | `center` |
| `#brxe-elolyz` | `align-self` | `<not set at desktop>` | `center` |
| `#brxe-elolyz` | `margin-top` | `50px` | `0` |
| `#brxe-xbltag` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-xbltag` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-xbltag` | `align-items` | `<not set at desktop>` | `center` |
| `#brxe-rwtyiy` | `height` | `<not set at desktop>` | `265px` |
| `#brxe-rwtyiy` | `flex-direction` | `<not set at desktop>` | `column` |
| `#brxe-jymgcu` | `height` | `<not set at desktop>` | `300px` |
| `#brxe-ygniry` | `align-self` | `<not set at desktop>` | `center` |
| `#brxe-ygniry` | `margin-top` | `50px` | `0` |
| `#brxe-iygoam` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-iygoam` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-iygoam` | `align-items` | `<not set at desktop>` | `center` |
| `#brxe-vnylcu` | `height` | `<not set at desktop>` | `265px` |
| `#brxe-diyyhz` | `height` | `<not set at desktop>` | `300px` |
| `#brxe-yadxiq` | `align-self` | `<not set at desktop>` | `center` |
| `#brxe-yadxiq` | `margin-top` | `50px` | `0` |
| `#brxe-danquv` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-danquv` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-danquv` | `align-items` | `<not set at desktop>` | `center` |
| `#brxe-cdgzbi` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-cdgzbi` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-cdgzbi` | `height` | `<not set at desktop>` | `265px` |
| `#brxe-ajxwjh` | `height` | `<not set at desktop>` | `300px` |
| `#brxe-rnkral` | `align-self` | `<not set at desktop>` | `center` |
| `#brxe-rnkral` | `margin-top` | `50px` | `0` |
| `#brxe-ugmthr` | `justify-content` | `<not set at desktop>` | `center` |
| `#brxe-ugmthr` | `align-items` | `<not set at desktop>` | `center` |
| `#brxe-ugmthr` | `align-self` | `<not set at desktop>` | `center !important` |
| `#brxe-zlsvss` | `height` | `<not set at desktop>` | `265px` |
| `#brxe-cackwy` | `height` | `<not set at desktop>` | `300px` |
| `#brxe-axagmd` | `width` | `100%` | `1366px` |
| `#brxe-axagmd` | `flex-direction` | `<not set at desktop>` | `column` |
| `#brxe-axagmd` | `height` | `700px` | `900px` |
| `#brxe-lmvaxg` | `height` | `<not set at desktop>` | `auto` |
| `#brxe-ubgffq` | `flex-direction` | `row` | `column` |
| `#brxe-ubgffq` | `width` | `90vw` | `100%` |
| `#brxe-cghplz` | `flex-direction` | `<not set at desktop>` | `column` |
| `#brxe-cghplz` | `height` | `100vh` | `auto` |
| `#brxe-cghplz` | `padding-top` | `3em` | `90px` |
| `#brxe-cghplz` | `padding-right` | `<not set at desktop>` | `1em` |
| `#brxe-cghplz` | `padding-bottom` | `3em` | `90px` |
| `#brxe-cghplz` | `padding-left` | `<not set at desktop>` | `1em` |
